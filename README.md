...
- **Всего тестов (pytest):** 22 (17 уникальных тестовых функций(было 16))
- **Успешно пройдено:** 22 (было 21, + 1 параметризованный тест)
- **Покрытие кода:** 100%
...
- **`test_add_new_book_with_names_min_1_normal_9_max_40_length_added_books`** — параметризованный тест валидных длин (1, 9, 40 символов)
